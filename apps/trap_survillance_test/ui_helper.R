            ...
            box(width = 4, title = "Controls", status = "primary", solidHeader = TRUE,
              ...
              conditionalPanel(
                ...
                sliderInput("lookback_days", "Historical Data (days):",
                           ...
                           post = " days"),
                selectInput("trap_grouping", "Pool Grouping:", 
                           choices = c("By Trap Location (recommended)" = "location",
                                     "By Individual Pool" = "individual"),
                           selected = "location"),
                helpText("By Trap Location: Groups pools from same physical trap")
              ),
